...
import (
	...
	gongplanning_orm "github.com/fullstack-lang/gongplanning/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*gongplanning_orm.BackRepoStruct
}
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*gongplanning_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *gongplanning_orm.BackRepoStruct, stackPath string) {
