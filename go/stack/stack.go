...
import (
	...
	"github.com/fullstack-lang/gongplanning/go/fullstack"
	"github.com/fullstack-lang/gongplanning/go/models"
	"github.com/fullstack-lang/gongplanning/go/orm"
	"github.com/fullstack-lang/gongplanning/go/probe"

	gongplanning_go "github.com/fullstack-lang/gongplanning/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gongplanning/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, gongplanning_go.GoModelsDir, gongplanning_go.GoDiagramsDir,
