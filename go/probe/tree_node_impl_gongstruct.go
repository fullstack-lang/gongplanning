...
func (nodeImplGongstruct *TreeNodeImplGongstruct) OnAfterUpdate(
	...
	// insertion point
	if nodeImplGongstruct.gongStruct.GetName() == "Predecessor" {
		fillUpTable[models.Predecessor](nodeImplGongstruct.probe)
	}
	if nodeImplGongstruct.gongStruct.GetName() == "Project" {
		fillUpTable[models.Project](nodeImplGongstruct.probe)
	}
	if nodeImplGongstruct.gongStruct.GetName() == "Task" {
		fillUpTable[models.Task](nodeImplGongstruct.probe)
	}
