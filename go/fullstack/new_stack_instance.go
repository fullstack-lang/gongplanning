...
import (
	"github.com/fullstack-lang/gongplanning/go/controllers"
	...
	_ "github.com/fullstack-lang/gongplanning/ng-github.com-fullstack-lang-gongplanning/projects"
)
...
func NewStackInstance(
	...
	// add orchestration
	// insertion point
	models.SetOrchestratorOnAfterUpdate[models.Predecessor](stage)
