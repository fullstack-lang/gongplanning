...
import (
	...
	"github.com/fullstack-lang/gongplanning"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongplanning.NgDistNg, "ng-github.com-fullstack-lang-gongplanning/dist/ng-github.com-fullstack-lang-gongplanning/browser")))
